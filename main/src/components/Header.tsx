...
export function Header() {
  ...
  return (
    <>
      <header className="safe-top orasage-site-mobile-bar bg-background lg:hidden">
        <Link href="/" className="orasage-site-mobile-bar-brand font-serif tracking-widest text-brand-gold">
          OraSage
        </Link>
        <HeaderAuthButton className="px-3 py-2 text-xs" />
      </header>

      <header className="safe-top hidden bg-background lg:block">
