-- Single-card: ensure base tables exist, then add Q&A / temple-free columns.
-- Self-contained so this migration can recover DBs where 20260710020000 was
-- recorded as applied without creating tables (or never ran).
...
CREATE TABLE IF NOT EXISTS "SingleCardDay" (
    ...
    "templeFreeReportUsed" BOOLEAN NOT NULL DEFAULT false,
...
-- Columns for DBs that already had the base tables without these fields
