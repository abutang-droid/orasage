...
const MoonIcon = () => (
  <svg width="34" height="34" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
    <path d="M21 12.8A9 9 0 1 1 11.2 3a7 7 0 0 0 9.8 9.8z" fill="rgba(107,114,128,0.1)" />
  </svg>
)
const CompassStar = () => (
  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M12 5l1.8 4.6L18 11l-4.2 1.4L12 17l-1.8-4.6L6 11l4.2-1.4L12 5z" fill="rgba(107,114,128,0.12)" />
  </svg>
)
const SunIcon = () => (
  <svg width="34" height="34" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="12" cy="12" r="4.2" fill="rgba(107,114,128,0.1)" />
...
const ThinkIcon = () => (
  <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M12 3a6 6 0 0 0-4 10.5c.7.7 1 1.2 1 2.5h6c0-1.3.3-1.8 1-2.5A6 6 0 0 0 12 3z" fill="rgba(107,114,128,0.08)" />
  </svg>
)
const ChooseIcon = () => (
  <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <rect x="8" y="4" width="10" height="14" rx="1.5" fill="rgba(107,114,128,0.08)" />
    <path d="M5 7v11a1.5 1.5 0 0 0 1.5 1.5H15" opacity="0.7" />
  </svg>
)
const ReadIcon = () => (
  <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7z" fill="rgba(107,114,128,0.06)" />
...
const HeartIcon = ({ color = "currentColor" }: { color?: string }) => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 20s-7-4.35-9.5-8.5C1 8.5 2.5 5 6 5c2 0 3 1.2 4 2.5C11 6.2 12 5 14 5c3.5 0 5 3.5 3.5 6.5C19 15.65 12 20 12 20z" fill="rgba(107,114,128,0.08)" />
  </svg>
)
const BriefcaseIcon = ({ color = "currentColor" }: { color?: string }) => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
    <rect x="3" y="7" width="18" height="13" rx="2" fill="rgba(107,114,128,0.08)" />
    <path d="M9 7V5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2M3 12h18" />
  </svg>
)
const DiamondIcon = ({ color = "currentColor" }: { color?: string }) => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
    <path d="M6 3h12l3 6-9 12L3 9l3-6z" fill="rgba(107,114,128,0.08)" />
    <path d="M3 9h18M9 3l-1 6 4 12 4-12-1-6" opacity="0.7" />
  </svg>
)
const LotusIcon = ({ color = "currentColor" }: { color?: string }) => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 4c1.8 2 2.5 4.2 2.5 7 0 1.5-1 3-2.5 3s-2.5-1.5-2.5-3c0-2.8.7-5 2.5-7z" fill="rgba(107,114,128,0.1)" />
...
const HandsHeartIcon = () => (
  <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 7.5C13 6 14 5.3 15.3 5.3c1.9 0 3.2 1.5 3.2 3.4 0 2.6-3.5 4.8-6.5 6.8-3-2-6.5-4.2-6.5-6.8 0-1.9 1.3-3.4 3.2-3.4C10 5.3 11 6 12 7.5z" fill="rgba(107,114,128,0.08)" />
    <path d="M4 20c1.5-1.5 3-2 5-2M20 20c-1.5-1.5-3-2-5-2" opacity="0.7" />
  </svg>
)
const CompassIcon = () => (
  <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="12" cy="12" r="9" fill="rgba(107,114,128,0.06)" />
    <path d="M15.5 8.5l-2 5-5 2 2-5 5-2z" fill="rgba(107,114,128,0.12)" />
  </svg>
)
const MeditationFigure = () => (
  <svg width="52" height="52" viewBox="0 0 64 64" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="32" cy="16" r="6" fill="rgba(107,114,128,0.12)" />
    <path d="M32 22c-6 0-10 5-10 12 0 3 1 5 2 7" fill="rgba(107,114,128,0.06)" />
    <path d="M32 22c6 0 10 5 10 12 0 3-1 5-2 7" fill="rgba(107,114,128,0.06)" />
    ...
    <div style={{ position: "relative", width: 104, height: 104, flexShrink: 0 }}>
      <svg width="104" height="104" viewBox="0 0 104 104">
        ...
        <circle
          ...
          stroke="#171717" strokeWidth="7" strokeLinecap="round"
      ...
      <div style={{
        ...
        <span style={{ fontFamily: "var(--font-serif)", fontSize: 24, fontWeight: 700, color: "var(--text-primary)", lineHeight: 1 }}>
          {pct}%
        </span>
      </div>
    </div>
...
export default function TarotHomePage() {
  ...
  const { energyPct, guidance, dims } = useMemo(() => {
    ...
    const S = {
      rising:   { en: "Rising",   zh: "上升", pt: "Em alta",  es: "En alza",   color: "#171717" },
      stable:   { en: "Stable",   zh: "平稳", pt: "Estável",  es: "Estable",   color: MONO },
      good:     { en: "Good",     zh: "良好", pt: "Bom",      es: "Bien",      color: "#171717" },
      cautious: { en: "Cautious", zh: "谨慎", pt: "Cauteloso",es: "Cauteloso", color: "#9CA3AF" },
      calm:     { en: "Calm",     zh: "平和", pt: "Calmo",    es: "Calma",     color: MONO },
    }
    const pool = {
  ...
  return (
    <div className="tarot-home">
      <section className="tarot-home-hero animate-fade-in-up">
        <div className="tarot-home-hero-cards animate-float">
          <div className="tarot-home-hero-card left"><div className="tarot-home-hero-card-inner"><MoonIcon /></div></div>
          <div className="tarot-home-hero-card right"><div className="tarot-home-hero-card-inner"><SunIcon /></div></div>
          <div className="tarot-home-hero-card center"><div className="tarot-home-hero-card-inner"><CompassStar /></div></div>
        </div>
        ...
        <p className="tarot-home-subtitle">
        ...
        <div className="tarot-home-cta-note">
      ...
      <section className="card animate-fade-in-up delay-100" style={{ padding: 18, marginBottom: 16 }}>
        <div className="tarot-home-section-title">
          {t({ en: "How It Works", zh: "如何使用", pt: "Como funciona", es: "Cómo funciona" }, "How It Works")}
        </div>
        <div className="tarot-home-steps">
          {steps.map(s => (
            <div key={s.num} className="tarot-home-step">
              <span className="tarot-home-step-num">{s.num}</span>
              <span className="tarot-home-step-icon"><s.Icon /></span>
              <span className="tarot-home-step-label">{t(s.label, s.label.en)}</span>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="card animate-fade-in-up delay-200" style={{ padding: 18, marginBottom: 16 }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div className="tarot-home-section-title" style={{ marginBottom: 0 }}>
            {t({ en: "Today's Energy", zh: "今日能量", pt: "Energia de hoje", es: "Energía de hoy" }, "Today's Energy")}
          </div>
          <Link href="/fortune" className="tarot-home-link">
        ...
        <div className="tarot-home-stats">
          {dims.map(dim => (
            <div key={dim.key} className="tarot-home-stat">
              <span className="tarot-home-stat-icon"><dim.Icon color={dim.status.color} /></span>
              <div className="tarot-home-stat-name">{t(dim.label, dim.label.en)}</div>
              <div className="tarot-home-stat-status" style={{ color: dim.status.color }}>
      ...
      <section className="animate-fade-in-up delay-300" style={{ marginBottom: 16 }}>
        ...
        <div className="tarot-home-picks">
          <Link href="/daily-card" className="tarot-home-pick">
            <span style={{ display: "block", marginBottom: 10, color: MONO }}><CompassIcon /></span>
            <div className="tarot-home-pick-title">
              {t({ en: "Daily Outlook", zh: "每日运势", pt: "Panorama diário", es: "Panorama diario" }, "Daily Outlook")}
            </div>
            <div className="tarot-home-pick-desc">
            ...
            <span className="tarot-home-pick-arrow">→</span>
          </Link>
          <Link href="/reading" className="tarot-home-pick">
            <span style={{ display: "block", marginBottom: 10, color: MONO }}><HandsHeartIcon /></span>
            <div className="tarot-home-pick-title">
      ...
      <section className="animate-fade-in-up delay-300" style={{ marginBottom: 16 }}>
        ...
        <Link href="/temple" style={{ textDecoration: "none" }}>
          <div className="card card-hover tarot-home-blessing">
            <div className="tarot-home-blessing-figure"><MeditationFigure /></div>
            <div style={{ flex: 1 }}>
              ...
              <span className="tarot-home-tap-hint"><TapIcon /> {t({ en: "Tap to bless", zh: "轻触祈福", pt: "Toque para abençoar", es: "Toca para bendecir" }, "Tap to bless")}</span>
            </div>
          </div>
        </Link>
      </section>
