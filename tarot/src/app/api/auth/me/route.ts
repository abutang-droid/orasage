  ...
  try {
    ...
    if (auth) {
      const user = await prisma.user.findUnique({
        ...
        select: { id: true, nickname: true, email: true, avatar: true, birthday: true, gender: true, occupation: true, preferredDeity: true, faith: true },
      })
    ...
    return NextResponse.json({
      user: { id: "guest", nickname: "旅人", email: "guest@tarot.app", birthday: null, gender: null, occupation: null, preferredDeity: null, faith: null },
    })
  }
}
