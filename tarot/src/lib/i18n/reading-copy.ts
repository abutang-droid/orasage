...
const singleCard = {
  ...
  subtitle: {
    zh: '当你不知如何选择时，从牌堆抽出一张，获得简洁的行动指引',
    en: 'When you cannot choose, draw from the deck for concise action guidance',
    pt: 'Quando não souber escolher, tire do baralho uma orientação de ação',
    es: 'Cuando no sepas elegir, saca del mazo una guía de acción',
  },
  introLead: {
    zh: '写下你正面临的抉择。然后从下方牌堆中，凭直觉点选一张。',
    en: 'Write the choice you face. Then tap one card from the deck below, guided by intuition.',
    pt: 'Escreva a escolha que enfrenta. Depois toque uma carta do baralho abaixo, pela intuição.',
    es: 'Escribe la decisión que enfrentas. Luego toca una carta del mazo, guiado por la intuición.',
  },
  questionLabel: { zh: '你的抉择', en: 'Your dilemma', pt: 'Seu dilema', es: 'Tu dilema' },
  questionPlaceholder: {
    zh: '例如：留下还是离开？接受还是拒绝？',
    en: 'e.g. Stay or leave? Accept or decline?',
    pt: 'ex.: Ficar ou ir? Aceitar ou recusar?',
    es: 'p. ej. ¿Quedarse o irse? ¿Aceptar o rechazar?',
  },
  questionTooShort: {
    zh: '请写下至少 4 个字的抉择描述',
    en: 'Please describe your dilemma (at least 4 characters)',
    pt: 'Descreva seu dilema (mínimo 4 caracteres)',
    es: 'Describe tu dilema (mínimo 4 caracteres)',
  },
  deckHint: {
    zh: '从牌堆中点选一张',
    en: 'Tap one card from the deck',
    pt: 'Toque uma carta do baralho',
    es: 'Toca una carta del mazo',
  },
  pickCard: {
    zh: '选牌',
    en: 'Pick card',
  ...
  writingGuidanceHint: {
    zh: '结合你的抉择与抽到的牌，给出简洁建议',
    en: 'Combining your dilemma with the drawn card',
    pt: 'Combinando seu dilema com a carta tirada',
    es: 'Combinando tu dilema con la carta sacada',
  },
  drawAgain: {
    zh: '再抽一张',
    en: 'Draw again',
  ...
  yourQuestion: { zh: '你的抉择', en: 'Your dilemma', pt: 'Seu dilema', es: 'Tu dilema' },
  ...
  paywallTitle: {
    zh: '解锁定命切片',
    en: 'Unlock Destiny Slice',
    pt: 'Desbloquear Fatia do Destino',
    es: 'Desbloquear Fragmento del Destino',
  },
  paywallDesc: {
    zh: '面临抉择不知何去何从？付费一次，永久从牌堆抽牌并获得行动指引。',
    en: 'Stuck between choices? Pay once to permanently draw from the deck and get action guidance.',
    pt: 'Preso entre escolhas? Pague uma vez para tirar cartas permanentemente e receber orientação.',
    es: '¿Atrapado entre opciones? Paga una vez para sacar cartas permanentemente y recibir guía.',
  },
  paywallMessage: {
    zh: '定命切片需登录 orasage 账号后购买解锁，解锁后永久可用。',
    en: 'Destiny Slice requires an orasage account. Unlock once, use forever.',
    pt: 'Fatia do Destino exige conta orasage. Desbloqueie uma vez, use para sempre.',
    es: 'Fragmento del Destino requiere cuenta orasage. Desbloquea una vez, usa para siempre.',
  },
  paywallHint: {
    zh: '登录后可购买永久解锁',
    en: 'Sign in to purchase permanent unlock',
    pt: 'Entre para comprar desbloqueio permanente',
    es: 'Inicia sesión para comprar desbloqueo permanente',
  },
  paywallCta: {
    zh: '登录 / 注册',
    en: 'Sign in / Register',
  ...
  buyUnlock: {
    zh: '付费解锁',
    en: 'Unlock now',
    pt: 'Desbloquear agora',
    es: 'Desbloquear ahora',
  },
  unlockForever: {
    zh: '一次付费，永久解锁抽牌与行动指引',
    en: 'Pay once — draw and get guidance forever',
    pt: 'Pague uma vez — tire cartas e receba orientação para sempre',
    es: 'Paga una vez — saca cartas y recibe guía para siempre',
  },
  loginBeforeBuy: {
    zh: '请先登录后再购买解锁',
...
const home = {
  ...
  singleCardDesc: {
    zh: '抉择迷茫时 · 从牌堆抽一张得行动指引',
    en: 'When stuck choosing · draw for action guidance',
    pt: 'Na dúvida · tire uma carta para orientação',
    es: 'En la duda · saca una carta para guía',
  },
  singleCardCta: {
    zh: '进入定命切片 →',
  ...
  singleCardUnlockBadge: {
    zh: '一次付费 · 永久解锁',
    en: 'Pay once · unlock forever',
    pt: 'Pague uma vez · desbloqueie para sempre',
    es: 'Paga una vez · desbloquea para siempre',
  },
