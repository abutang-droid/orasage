...
const singleCard = {
  label: { zh: '问题切片', en: 'Focused slice', pt: 'Fatia focada', es: 'Fragmento enfocado' },
  title: {
    zh: '问题切片 // FOCUS',
    en: 'Focused slice // FOCUS',
    pt: 'Fatia focada // FOCUS',
    es: 'Fragmento enfocado // FOCUS',
  },
  statusBadge: {
    zh: '[ 状态：单点聚焦 // 非零即一判断 ]',
  ...
  energyProbabilityLabel: { zh: '倾向强度', en: 'Tendency strength', pt: 'Força da tendência', es: 'Fuerza de la tendencia' },
  ...
  paywallFallback: {
    zh: '问题切片 · 一次付费永久解锁',
    en: 'Focused slice · pay once, unlock forever',
    pt: 'Fatia focada · pague uma vez, desbloqueie para sempre',
    es: 'Fragmento enfocado · paga una vez, desbloquea para siempre',
  },
  buyUnlock: {
    zh: '付费查看切片',
    en: 'Unlock slice',
...
const dailyFortune = {
  ...
  drawingHint: {
    zh: '牌阵整理中，马上揭晓',
    en: 'Preparing the spread — reveal coming soon',
...
const home = {
  ...
  mentorFallback: {
    zh: '每天一个角度，换种方式看这一周。',
    en: 'A daily prompt to look at your week from a different angle.',
  ...
  singleCardTitle: { zh: '问题切片', en: 'Focused slice', pt: 'Fatia focada', es: 'Fragmento enfocado' },
  singleCardDesc: {
    zh: '把一个问题的某一切面放大来看',
    en: 'A focused slice of one question',
  ...
  singleCardCta: {
    zh: '进入问题切片 →',
    en: 'Enter Focused slice →',
    pt: 'Entrar na Fatia focada →',
    es: 'Entrar al Fragmento enfocado →',
  },
  singleCardUnlockBadge: {
    zh: '抽牌免费 · 登录后可看完整文字',
    en: 'Free draw · full write-up after sign-in',
  ...
  threeCardDesc: {
    zh: '同一件事的三种 framing——之前、此刻、之后',
    en: 'Three framings of the same situation — before, now, after',
  ...
  dailyInsightLine1: {
    zh: '每一天，都有不同的题目可以想想。',
    en: 'Each day brings a different set of prompts to reflect on.',
  ...
  threeCardNote: {
    zh: '更长的文字版在登录后可看',
    en: 'A longer write-up is available after sign-in',
