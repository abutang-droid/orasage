...
const singleCard = {
  label: { zh: '单牌占卜', en: 'Single-card reading', pt: 'Leitura de uma carta', es: 'Lectura de una carta' },
  title: {
    zh: '一问一牌，是或非',
    en: 'One question, one answer',
    pt: 'Uma pergunta, uma resposta',
    es: 'Una pregunta, una respuesta',
  },
  subtitle: {
    zh: '写下明确问题，抽牌后得到是/否方向的启示',
    en: 'Ask a clear question and draw a card for a yes-or-no style insight',
    pt: 'Faça uma pergunta clara e tire uma carta para uma resposta sim/não',
    es: 'Haz una pregunta clara y saca una carta para una respuesta sí/no',
  },
  introLead: {
    zh: '请用一句完整的话写下你想问的事。问题越明确，启示越清晰。',
    en: 'Write your question in a full sentence. The clearer the question, the clearer the insight.',
    pt: 'Escreva sua pergunta em uma frase completa. Quanto mais clara, melhor a resposta.',
    es: 'Escribe tu pregunta en una frase completa. Cuanto más clara, más clara la respuesta.',
  },
  questionLabel: { zh: '你的问题', en: 'Your question', pt: 'Sua pergunta', es: 'Tu pregunta' },
  questionPlaceholder: {
    zh: '例如：我应该接受这份新工作吗？',
    en: 'e.g. Should I accept this new job offer?',
    pt: 'ex.: Devo aceitar esta nova proposta de trabalho?',
    es: 'p. ej. ¿Debería aceptar esta nueva oferta de trabajo?',
  },
  questionTooShort: {
    zh: '请写下至少 4 个字的明确问题',
    en: 'Please write a clear question (at least 4 characters)',
    pt: 'Escreva uma pergunta clara (mínimo 4 caracteres)',
    es: 'Escribe una pregunta clara (mínimo 4 caracteres)',
  },
  start: {
    zh: '抽牌得启示',
    en: 'Draw for insight',
  ...
  templeBonusHint: {
    zh: '神庙祈福可额外 +1 次抽牌',
    en: 'Temple worship grants +1 extra draw',
    pt: 'Templo concede +1 sorteio extra',
    es: 'El templo otorga +1 tirada extra',
  },
  drawing: {
    zh: '正在为你随机抽牌…',
  ...
  writingVerdict: {
    zh: '正在解读是/否启示…',
    en: 'Interpreting your yes/no insight…',
    pt: 'Interpretando sua resposta sim/não…',
    es: 'Interpretando tu respuesta sí/no…',
  },
  writingVerdictHint: {
    zh: '结合你的问题与抽到的牌给出结论',
    en: 'Combining your question with the drawn card',
    pt: 'Combinando sua pergunta com a carta tirada',
    es: 'Combinando tu pregunta con la carta sacada',
  },
  drawAgain: {
    zh: '再问一次（剩余 {n} 次）',
    en: 'Ask again ({n} left)',
    pt: 'Perguntar de novo ({n} restantes)',
    es: 'Preguntar de nuevo ({n} restantes)',
  },
  quotaExhaustedTitle: {
    zh: '今日次数已用完',
  ...
  quotaExhaustedDesc: {
    zh: '每日免费 1 次抽牌；神庙祈福可额外 +1 次。明日再来，或先去神庙祈福。',
    en: '1 free draw daily; temple worship grants +1 extra. Come back tomorrow or worship first.',
    pt: '1 sorteio grátis por dia; templo concede +1 extra. Volte amanhã ou adore no templo.',
    es: '1 tirada gratis al día; el templo otorga +1 extra. Vuelve mañana o adora en el templo.',
  },
  templeBonus: {
    zh: '去神庙祈福 +1',
  ...
  verdictFailed: {
    zh: '启示生成失败',
    en: 'Could not generate insight',
    pt: 'Falha ao gerar revelação',
    es: 'Error al generar revelación',
  },
  yourQuestion: { zh: '你的问题', en: 'Your question', pt: 'Sua pergunta', es: 'Tu pregunta' },
  verdictLabel: { zh: '启示结论', en: 'Insight', pt: 'Revelação', es: 'Revelación' },
  verdictYes: { zh: '肯定', en: 'Affirmative', pt: 'Afirmativo', es: 'Afirmativo' },
  verdictNo: { zh: '否定', en: 'Negative', pt: 'Negativo', es: 'Negativo' },
  verdictLeanYes: { zh: '倾向肯定', en: 'Leans yes', pt: 'Inclina-se ao sim', es: 'Inclina al sí' },
  verdictLeanNo: { zh: '倾向否定', en: 'Leans no', pt: 'Inclina-se ao não', es: 'Inclina al no' },
  verdictUnclear: { zh: '尚不确定', en: 'Not yet clear', pt: 'Ainda incerto', es: 'Aún incierto' },
  explanationTitle: { zh: '解读说明', en: 'Explanation', pt: 'Explicação', es: 'Explicación' },
  guidanceTitle: { zh: '行动建议', en: 'Guidance', pt: 'Orientação', es: 'Orientación' },
  legacyHeadline: {
    zh: '牌面启示',
    en: 'Card insight',
    pt: 'Revelação da carta',
    es: 'Revelación de la carta',
  },
} as const satisfies Record<string, LangMap>;
...
const home = {
  ...
  singleCardDesc: {
    zh: '明确问题 · 抽牌得是/否启示',
    en: 'Clear question · yes/no insight',
    pt: 'Pergunta clara · resposta sim/não',
    es: 'Pregunta clara · respuesta sí/no',
  },
  singleCardCta: {
    zh: '开始单牌占卜 →',
...
export function useSingleCardCopy() {
  ...
  return useMemo(() => {
    const p = (map: LangMap) => pick(map, lang);
    const verdictKind = (kind: string) => {
      if (kind === 'yes') return p(singleCard.verdictYes);
      if (kind === 'no') return p(singleCard.verdictNo);
      if (kind === 'lean_yes') return p(singleCard.verdictLeanYes);
      if (kind === 'lean_no') return p(singleCard.verdictLeanNo);
      return p(singleCard.verdictUnclear);
    };
    return {
      ...commonCopy,
      ...three,
      ...
      questionTooShort: p(singleCard.questionTooShort),
      ...
      writingVerdict: p(singleCard.writingVerdict),
      writingVerdictHint: p(singleCard.writingVerdictHint),
      ...
      verdictFailed: p(singleCard.verdictFailed),
      yourQuestion: p(singleCard.yourQuestion),
      verdictLabel: p(singleCard.verdictLabel),
      verdictKind,
      explanationTitle: p(singleCard.explanationTitle),
      guidanceTitle: p(singleCard.guidanceTitle),
      legacyHeadline: p(singleCard.legacyHeadline),
    };
