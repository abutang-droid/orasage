...
const singleCard = {
  ...
  introLead: {
    zh: '先在心中默念你想问的事，然后抽一张牌。每次抽牌都是随机的，牌面会回应你此刻的疑问。',
    en: 'Hold a question in your mind, then draw one card. Each draw is random — the card responds to what you are asking now.',
    pt: 'Mentalize sua pergunta e tire uma carta. Cada sorteio é aleatório — a carta responde ao que você pergunta agora.',
    es: 'Mantén una pregunta en mente y saca una carta. Cada tirada es aleatoria — la carta responde a lo que preguntas ahora.',
  },
  questionLabel: { zh: '你的问题', en: 'Your question', pt: 'Sua pergunta', es: 'Tu pregunta' },
  questionPlaceholder: {
  ...
  templeBonusHint: {
    zh: '神庙祈福可额外 +1 次',
    en: 'Worship at temple for +1 draw',
    pt: 'Adorar no templo +1 sorteio',
    es: 'Adorar en el templo +1 tirada',
  },
  drawing: {
    zh: '正在为你随机抽牌…',
  ...
  writingBriefHint: {
    zh: '结合你的问题与牌面，生成解读中',
    en: 'Combining your question and the card',
    pt: 'Combinando sua pergunta e a carta',
    es: 'Combinando tu pregunta y la carta',
  },
  drawAgain: {
    zh: '再抽一次（剩余 {n} 次）',
  ...
  quotaExhaustedDesc: {
    zh: '每日免费 1 次，神庙祈福可额外 +1 次。明日再来，或先去神庙祈福。',
    en: '1 free draw daily; temple worship grants +1. Come back tomorrow, or worship at the temple first.',
    pt: '1 sorteio grátis por dia; templo concede +1. Volte amanhã ou adore no templo.',
    es: '1 tirada gratis al día; el templo otorga +1. Vuelve mañana o adora en el templo.',
  },
  templeBonus: {
    zh: '去神庙祈福 +1',
  ...
  briefFailed: {
    ...
    en: 'Brief reading failed',
    pt: 'Falha na leitura breve',
    es: 'Error en lectura breve',
  },
  freeBrief: { zh: '免费简读', en: 'Free brief', pt: 'Leitura breve grátis', es: 'Lectura breve gratis' },
  unlockLead: {
    zh: '完整详读包含深度解读、行动建议与肯定语，登录后可购买解锁并保存到用户中心。',
    en: 'The full report includes deep analysis, action steps, and affirmations. Sign in to purchase and save to your profile.',
    pt: 'O relatório completo inclui análise profunda, ações e afirmações. Entre para comprar e salvar no perfil.',
    es: 'El informe completo incluye análisis profundo, acciones y afirmaciones. Inicia sesión para comprar y guardar en tu perfil.',
  },
  loginUnlock: {
  ...
  paywallHint: {
    zh: '简读仍可免费查看；登录后可购买详读。',
    en: 'Brief reading stays free; sign in to buy the full report.',
    pt: 'Leitura breve continua grátis; entre para comprar o relatório.',
    es: 'Lectura breve sigue gratis; inicia sesión para comprar el informe.',
  },
  paywallCta: {
    zh: '登录 / 注册',
    en: 'Sign in / Register',
  ...
  tier1Title: { zh: '完整详读', en: 'Full report', pt: 'Relatório completo', es: 'Informe completo' },
  tier1Fallback: {
    zh: '单牌阵完整详读报告',
  ...
  paidView: { zh: '完整详读', en: 'Full report', pt: 'Relatório completo', es: 'Informe completo' },
  backBrief: { zh: '返回简读', en: 'Back to brief', pt: 'Voltar à leitura breve', es: 'Volver a lectura breve' },
  fullSynthesis: { zh: '综合解读', en: 'Overall reading', pt: 'Leitura geral', es: 'Lectura general' },
...
const home = {
  ...
  singleCardDesc: {
    zh: '心中一问，随机抽牌 · 简读免费',
    en: 'Hold a question, draw random · brief free',
    pt: 'Pergunta mental, carta aleatória · breve grátis',
    es: 'Pregunta mental, carta al azar · breve gratis',
  },
  singleCardCta: {
    zh: '开始单牌占卜 →',
