...
type HomeTileCtaProps = {
  ...
  /** @deprecated All CTAs use dark primary chrome; kept for call-site compatibility. */
  primary?: boolean;
};

/** Strip CTA inside home tiles — dark primary + lucide icon per design-system §9. */
export function HomeTileCta({ label, variant }: HomeTileCtaProps) {
