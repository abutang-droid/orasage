  ...
  return (
    <nav className="orasage-app-bottomnav" aria-label="App navigation">
      <div className="orasage-app-bottomnav-inner">
        <a href={portalHref} className="orasage-app-nav-item" data-active="false">
          <NavIcon name="home" active={false} />
          <span>{pickLabel(SHELL_LABELS.home, locale)}</span>
        </a>

        <a href={appHref} className="orasage-app-nav-item" data-active={onAppHome ? 'true' : 'false'}>
