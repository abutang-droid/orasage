  ...
  return (
    <header className="safe-top border-b border-sage-border/40 bg-sage-bg">
      <div className="safe-x mx-auto flex h-12 max-w-6xl items-center justify-between px-4 sm:px-6">
        <span className="font-serif text-base tracking-wide text-sage-gold sm:text-lg">{title}</span>
        {showBack ? (
          <button
            type="button"
          ...
          <Link href="https://orasage.com/zh-CN" className="text-xs text-sage-muted hover:text-sage-primary">
            主站
          </Link>
        )}
      </div>
