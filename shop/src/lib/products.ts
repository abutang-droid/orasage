...
export const FALLBACK_PRODUCTS: Product[] = [
  ...
  { sku: 'crystal-wood-gift', name: '生长之境 · 绿幽灵能量手串 · 礼盒装', element: '木', packaging: '精美礼盒 · 祝福卡 · 绒布袋', desc: '五行属木 · 赠礼专属包装', priceCents: 16800, priceCentsUsd: 2333, category: 'crystal' },
  { sku: 'crystal-fire-gift', name: '焰心觉醒 · 红玛瑙能量手串 · 礼盒装', element: '火', packaging: '精美礼盒 · 祝福卡 · 绒布袋', desc: '五行属火 · 赠礼专属包装', priceCents: 13800, priceCentsUsd: 1917, category: 'crystal' },
