...
export const FALLBACK_PRODUCTS: Product[] = [
  ...
  { sku: 'report-bazi', name: '八字深度报告', desc: '完整命盘解析 · PDF 交付', priceCents: 944, priceCentsUsd: 944, category: 'report' },
  ...
  { sku: 'report-ziwei', name: '紫微深度报告', desc: '十二宫详解 · 流年运势', priceCents: 1083, priceCentsUsd: 1083, category: 'report' },
  ...
  { sku: 'service-consult', name: '能量咨询 30 分钟', desc: '一对一命理师在线答疑', priceCents: 2750, priceCentsUsd: 2750, category: 'service' },
