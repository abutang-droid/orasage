...
export const FALLBACK_PRODUCTS: Product[] = [
  ...
  { sku: 'crystal-wood-gift', name: '生长之境 · 绿幽灵能量手串 · 礼盒装', element: '木', packaging: '精美礼盒 · 祝福卡 · 绒布袋', desc: '五行属木 · 赠礼专属包装', priceCents: 59900, priceCentsUsd: 59900, category: 'crystal' },
  { sku: 'crystal-fire-gift', name: '焰心觉醒 · 红玛瑙能量手串 · 礼盒装', element: '火', packaging: '精美礼盒 · 祝福卡 · 绒布袋', desc: '五行属火 · 赠礼专属包装', priceCents: 59900, priceCentsUsd: 59900, category: 'crystal' },
  { sku: 'crystal-earth-gift', name: '厚土之根 · 黄水晶能量手串 · 礼盒装', element: '土', packaging: '精美礼盒 · 祝福卡 · 绒布袋', desc: '五行属土 · 赠礼专属包装', priceCents: 59900, priceCentsUsd: 59900, category: 'crystal' },
  { sku: 'crystal-metal-gift', name: '澄明之境 · 白水晶能量手串 · 礼盒装', element: '金', packaging: '精美礼盒 · 祝福卡 · 绒布袋', desc: '五行属金 · 赠礼专属包装', priceCents: 59900, priceCentsUsd: 59900, category: 'crystal' },
  { sku: 'crystal-water-gift', name: '深海静盾 · 黑曜石能量手串 · 礼盒装', element: '水', packaging: '精美礼盒 · 祝福卡 · 绒布袋', desc: '五行属水 · 赠礼专属包装', priceCents: 59900, priceCentsUsd: 59900, category: 'crystal' },
  ...
  { sku: 'report-bazi-couple-basic', name: '八字合盘深度解读', desc: '双人合盘 AI 解读报告', priceCents: 138, priceCentsUsd: 138, category: 'report' },
  ...
  { sku: 'report-ziwei-basic', name: '紫微深度解读', desc: '命盘 AI 解读报告', priceCents: 138, priceCentsUsd: 138, category: 'report' },
