...
export const DEFAULT_CRYSTAL_CONTENT: CrystalContentMap = {
  'crystal-wood': {
    ...
    keywords: ['意向', '事业', '生机', '拓展'],
    benefits: [
      '开启新阶段时稳定心神，聚焦目标',
      '事业拓展时的心理锚定意象',
      '象征生长，适合长期佩戴养护',
    ],
    ritual: '晨间通勤佩戴于左手，工作时置于案头左上角，提醒自己向光而行。',
    packNote: '',
  },
  'crystal-fire': {
    tagline: '焰心觉醒',
  ...
  'crystal-metal': {
    tagline: '澄明之境',
    story:
      '白水晶是水晶家族中最纯粹的存在，无色透亮，包容一切光谱。它属金，主澄澈与秩序——当思绪混乱、信息驳杂，它像一面澄澈的镜子，帮你过滤噪音，回到清晰。',
    keywords: ['澄澈', '静定', '专注', '秩序'],
    benefits: [
      '澄澈意象，重置身心状态',
      '提升专注与思维清晰度',
      '百搭基础款，可与任意元素叠戴',
  ...
  'crystal-water': {
    ...
    keywords: ['守护', '边界', '沉静', '锚点'],
    benefits: [
      '建立心理边界，减少情绪过载',
      '高压工作与复杂环境的随身心理锚点',
      '助眠安神，缓解思虑过度',
    ],
    ritual: '外出应酬或高压场合佩戴于左手，归家后取下置于玄关，隔断外界噪音。',
    packNote: '',
  },
};
