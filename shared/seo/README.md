...
Canonical source: `shared/seo/metadata.ts`

Synced copies (update together when changing):

- `main/src/lib/orasage-seo.ts`
- `shop/src/lib/orasage-seo.ts`
- `tarot/src/lib/orasage-seo.ts`
