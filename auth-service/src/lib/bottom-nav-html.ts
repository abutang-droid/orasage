...
<nav class="orasage-app-bottomnav" aria-label="App navigation">
  <div class="orasage-app-bottomnav-inner">
    ...
    <a href="${main}/famous" class="orasage-app-nav-item" data-active="false">
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--shell-muted)" stroke-width="1.6"><circle cx="12" cy="12" r="9"/><path d="M12 3v18M3 12h18"/></svg>
      <span>探索</span>
    </a>
