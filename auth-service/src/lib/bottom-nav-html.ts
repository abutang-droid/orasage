...
export function bottomNavHtml(locale = 'zh-CN'): string {
  const profile = `https://orasage.com/${locale}/profile`;
...
<nav class="orasage-app-bottomnav" aria-label="App navigation">
  <div class="orasage-app-bottomnav-inner">
    <a href="https://tarot.orasage.com" class="orasage-app-nav-item" data-active="false">
    ...
    <a href="https://bazi.orasage.com" class="orasage-app-nav-item" data-active="false">
