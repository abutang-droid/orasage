...
> 写给下一任 Agent / 开发者。  
> 最后更新：**2026-08-29**（家里机 tunnel 已通；`/scene` 尚未上生产）  
> **2026-08-29 家里机已联通、待部署玄隐 `/scene`：** [`HANDOFF-bazi-scene-deploy-2026-08-29.md`](./HANDOFF-bazi-scene-deploy-2026-08-29.md) ← **当前部署任务先读这个**  
> **2026-07-08 会话交接（塔罗 i18n + ziwei @orasage/ui 全量）：** [`HANDOFF-agent-2026-07-08.md`](./HANDOFF-agent-2026-07-08.md)  
